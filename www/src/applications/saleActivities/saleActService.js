...
salesModule.factory('saleActService', [function () {
    ...
    return {
        ...
        getATLCustomer:function(){
            return customerTypeArr_ATL;
        },
        ...
        actDetail:actDetail,
        createPopTypes:createPopTypes,
        urgentDegreeArr:urgentDegreeArr,
        processArr:processArr,
        positonArr:positonArr,
        processTypesArr:processTypesArr,
        relationPositionArr:relationPositionArr,
        relationPositionForAdd:relationPositionForAdd,
        filters:filters,
        customerTypeArr_server:customerTypeArr_server,
        customerTypeArr_ATL:customerTypeArr_ATL,
