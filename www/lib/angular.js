 ...
 * @name $httpProvider
 * @description
 * Use `` to change the default behavior of the {@link ng.$http $http} service.
 * */
function $HttpProvider() {
   ...
   *
   * @returns {boolean|Object} If a value is specified, returns the  for chaining.
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * can be fully configured by accessing the `.defaults.headers` configuration
